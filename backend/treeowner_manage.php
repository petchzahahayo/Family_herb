<?php
        ...
        //คำสั่ง sql
        $sql = "SELECT * FROM tree_owner ORDER BY treeowner_id ASC";
...
<html>
    ...
    <body>
        <div class="container">
            <a href="frm_treeowner_add.php" class="btn btn-primary" >
...
<!--                        <th><center>#</center></th>-->
                ...
                <tbody>
                    <tr>
                        ...
                        <!-- ดูข้อมูล -->
                        <td><center><a href="show_treeowner_data.php?treeowner_id=<?php echo $row['treeowner_id']; ?>" class="btn btn-info btn-md">
