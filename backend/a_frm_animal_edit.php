...
<html>
    ...
    <body>
        <div class="container">
            ...
            <br>
            <form action="a_animal_edit.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <!-- name_th -->
                <div class="form-group">
                    <label for="treename_id" class="col-md-2 control-label">ชื่อสัตว์ :</label>
                    <div class="col-md-10">
                ...
                <!-- treedata_hight -->
                <div class="form-group">
                    <label class="col-md-2 control-label">ความสูงของสัตว์ :</label>
                    <div class="col-md-10">
                ...
                <!-- treedata_wideth -->
                <div class="form-group">
                    <label class="col-md-2 control-label">ความกว้างของสัตว์ :</label>
                    <div class="col-md-10">
                ...
                <!-- treedata_radius -->
                <div class="form-group">
                    <label class="col-md-2 control-label">เส้นรอบวงของสัตว์ :</label>
                    <div class="col-md-10">
                ...
                <!-- data_detail -->
                <div class="form-group">
                    <label class="col-md-2 control-label">ลักษณะของสัตว์ :</label>
                    <div class="col-md-10">
