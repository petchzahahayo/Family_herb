        ...
        <div class="container">
            ...
            <form action="a_animal_typename_edit.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="treetype_name" class="col-md-2 control-label">ประเภทต้นไม้ :</label>
                    <div class="col-md-10">
                        <input name="a_animaltype_name" type="text" class="form-control" value="<?php echo $row_treetypename['treetype_name']; ?>">
                    </div>
                </div>   
                
                <!-- type_details -->
                <div class="form-group">
                    <label for="a_animaltype_details" class="col-md-2 control-label">รายละเอียด :</label>
                    <div class="col-md-10">
