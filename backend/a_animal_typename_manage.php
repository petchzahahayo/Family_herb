            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <!-- edit -->
                        <td><center><a href="a_frm_animal_typename_edit.php?treetype_id=<?php echo $row['treetype_id']; ?>" class="btn btn-warning btn-md">
                                <span class="glyphicon glyphicon-edit"></span>
                        </a></center></td>
                        
                        <!-- delete -->
                        <td><center><a type="button" onclick="comfirmDelete()" href="a_animal_typename_delete.php?animaltype_id=<?php echo $row['treetype_id']; ?>" class="btn btn-danger btn-md">
