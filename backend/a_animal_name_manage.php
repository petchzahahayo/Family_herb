...
<html>
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <a href="a_frm_animal_name_add.php" class="btn btn-primary" >
                        <span class="glyphicon glyphicon-plus"> เพิ่มชื่อสัตว์</span>
                    </a>
                </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <!-- edit -->
                        <td><center><a href="a_frm_animal_name_edit.php?treename_id=<?php echo $row['treename_id']; ?>" class="btn btn-warning btn-md">
                                <span class="glyphicon glyphicon-edit"></span>
                        </a></center></td>
                        
                        <!-- delete -->
                        <td><center><a href="a_animal_name_delete.php?treename_id=<?php echo $row['treename_id']; ?>" class="btn btn-danger btn-md">
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        <?php for ($i = 1; $i <= $total_page; $i++) { ?>
                            <li><a href="a_animal_name_manage.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                        <?php } ?>
                            <li class="active">
                            <a href="a_animal_name_manage.php?page=<?php echo $total_page; ?>" aria-label="Next">
