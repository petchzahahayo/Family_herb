<?php
        ...
        //คำสั่ง sql
        $sql = "INSERT INTO tree_data (treedata_id, treetype_id, treename_id, treedata_name_eng, treedata_name_sci, treedata_detail, treedata_hight, treedata_wideth) 
                VALUES ('$treedata_id', '$treetype_id', '$treename_id', '$treedata_name_eng', '$treedata_name_sci', '$treedata_detail', '$treedata_hight', '$treedata_wideth')";
